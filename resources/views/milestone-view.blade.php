...
<head>
  <title>Milestone View Page</title>
  <!-- JQUERY -->
...
<body data-user="{{ $ruko_user }}" data-local="{{ App::environment() == 'development' }}">
  <div style="width:100%; min-height:100%; padding-bottom: 100px; padding-top: 20px; background-color: #f8f8f8">
    <div class="ms-page-content">
      <div id="ms-page-body" data-id="{{ $milestone_id }}" style="display: flex; flex-direction: column; justify-content: center; max-width: 920px; width:100%;">
        
      </div>
    </div>
  </div>
  <script type="text/javascript" src="{{ asset('js/milestone-view.js') }}"></script>
</body>
