...
define('TEXT_MODULE_DADATA_MAX_COUNT_INFO','Максимальное количество подсказок в выпадающем списке. По умолчанию 5. Не может быть больше 20.');
...
define('TEXT_MODULE_DADATA_RULES_INFO','Данные правила служат для заполнения конкретных полей, после выбора подсказки. Пример правила:<br>
[248] = data.city<br>
[247] = data.country<br>
