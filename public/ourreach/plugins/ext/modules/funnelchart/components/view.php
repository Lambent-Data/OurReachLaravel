...
<!-- handle listing -->
<?php $listing_container = 'entity_items_listing' . $reports_info['id'] . '_' . $reports_info['entities_id']; ?>
...
<div id="<?php echo $listing_container;  ?>" class="entity_items_listing"><?php echo TEXT_EXT_CLICK_CHART_BAR ?></div>
