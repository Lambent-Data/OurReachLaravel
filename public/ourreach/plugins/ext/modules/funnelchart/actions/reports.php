...
switch($app_module_action)
{
  ...
  case 'delete':
      ...
      $report_info_query = db_query("select * from app_reports where reports_type='funnelchart" . db_input($_GET['id']). "'");
  ...
  case 'get_entities_fields':
        ...
        $html .= '
         <div class="form-group">
            ...
            <div class="col-md-9">
          	   <p class="form-control-static">' . input_checkbox_tag('hide_zero_values',1,['checked'=>$obj['hide_zero_values']]). '</p>               	                  
            </div>
          </div>
        ';
