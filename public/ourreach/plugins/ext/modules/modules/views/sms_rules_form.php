...
?>    
    ...
    <div class="form-group">
      ...
      <div class="col-md-9">	
    	  <?php echo select_tag('action_type',sms::get_action_type_choices(), $obj['action_type'],array('class'=>'form-control required chosen-select','onChange'=>'ext_get_entities_fields()')) ?>        
      </div>			
    </div>
    ...
    <div class="form-group">
	  	<label class="col-md-3 control-label" for="cfg_sms_send_to_number_text"><?php echo TEXT_EXT_MESSAGE_TEXT; ?></label>
	    <div class="col-md-9">	
	  	  <?php echo textarea_tag('description', $obj['description'],array('class'=>'form-control input-xlarge textarea-small required')); ?>
