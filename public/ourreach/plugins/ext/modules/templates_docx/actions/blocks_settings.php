...
switch($field['type'])
{
    ...
    case 'fieldtype_user_roles':    
        ...
        <!--list-->
          ...
          <div class="form-group settings-list">
            ...
            <div class="col-md-9">' . input_tag('settings[empty_row]',$settings->get('empty_row','0'),['class'=>'form-control input-xsmall required number']) . '</div>			
          </div>
    ...
    case 'fieldtype_dropdown_multiple':
        ...
        $html ='
          ...
          <div class="form-group settings-list">
            <label class="col-md-3 control-label" for="fields_id">' . TEXT_EXT_FONT_NAME . '</label>
            <div class="col-md-9">' . input_tag('settings[font_name]',$settings->get('font_name','Times New Roman'),['class'=>'form-control input-medium required']) . '</div>
          </div>
