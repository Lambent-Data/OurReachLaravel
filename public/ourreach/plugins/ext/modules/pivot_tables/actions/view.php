...
switch($app_module_action)
{
    ...
    case 'get_csv':
        ...
        $listing_sql_query_select = fieldtype_formula::prepare_query_select($pivot_table->entities_id, $listing_sql_query_select);
        ...
        while($item = db_fetch_array($items_query))
        {
            ...
            {
                $output_array = pivot_tables::prepare_csv_output_for_parent_entities($output_array,$parent_entities_listing_fields,$parrent_entities,$item['parent_item_id'],$parent_entities_fields_dates_format);
            }
