...
<?php echo form_tag('events', url_for('ext/calendar/personal','action=save' . (isset($_GET['id']) ? '&id=' . $_GET['id'] : '')),array('class'=>'form-horizontal')) ?>
...
<div class="tab-content">
  <div class="tab-pane fade active in" id="general_info">
    ...
    <div class="form-group">
      ...
      <div class="col-md-9">	
    	  <?php echo input_tag('bg_color',$obj['bg_color'],array('class'=>'simple-colorpicker')) ?>        
      </div>			
    </div>
    
    <?php if(calendar::user_has_public_full_access()): ?>
    <div class="form-group">
    	<label class="col-md-3 control-label" for="is_public"><?php echo TEXT_EXT_EVENT_DISPLAY_IN_PUBLIC ?></label>
      <div class="col-md-9">	
    	  <p class="form-control-static"><?php echo input_checkbox_tag('is_public',1,array('class'=>'form-control input-xsmall','checked'=>($obj['is_public']==1 ? 'checked':''))) ?></p>        
      </div>			
    </div>
    <?php endif ?>
