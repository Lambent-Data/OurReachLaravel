...
<tr>
  ...
  <td><?php 
      ...
      {
          echo '<br><small>&nbsp;&nbsp;' . TEXT_QUICK_FILTERS_PANELS . ': <a href="' . url_for('ext/filters_panels/fields','panels_id=' . $panels_id . '&entities_id=' . $reports['entities_id'] . '&redirect_to=calendar_report_' . $reports['id']) . '">' . TEXT_CONFIGURE . '</a></small></small>';
      }
  ?></td> 
