...
<?php echo form_tag('configuration_form', url_for('ext/pivot_calendars/reports','action=save' . (isset($_GET['id']) ? '&id=' . $_GET['id']:'') ),array('class'=>'form-horizontal')) ?>
...
?>
    ...
    <div class="form-group">
	  	<label class="col-md-3 control-label" for="display_legend"><?php echo tooltip_icon(TEXT_EXT_PIVOT_CALENDAR_DISPLAY_LEGEND_TIP) . TEXT_EXT_DISPLAY_LEGEND ?></label>
	    <div class="col-md-9">	
