...
if(!defined('CFG_ENABLE_CHAT')) define('CFG_ENABLE_CHAT',0);
if(!defined('CFG_CHAT_SEND_ALERTS')) define('CFG_CHAT_SEND_ALERTS',0);
if(!defined('CFG_CHAT_ALERTS_SUBJECT')) define('CFG_CHAT_ALERTS_SUBJECT','');
if(!defined('CFG_CURRENCIES_UPDATE_MODULE')) define('CFG_CURRENCIES_UPDATE_MODULE','cbr');
if(!defined('CFG_CURRENCIES_WIDGET_USERS_GROUPS')) define('CFG_CURRENCIES_WIDGET_USERS_GROUPS','');
if(!defined('CFG_INCOMING_CALL_ENTITY')) define('CFG_INCOMING_CALL_ENTITY',0);
if(!defined('CFG_INCOMING_CALL_FIELD')) define('CFG_INCOMING_CALL_FIELD','');
if(!defined('CFG_PERSONAL_CALENDAR_DEFAULT_VIEW')) define('CFG_PERSONAL_CALENDAR_DEFAULT_VIEW','month');
if(!defined('CFG_PERSONAL_CALENDAR_HIGHLIGHTING_WEEKENDS')) define('CFG_PERSONAL_CALENDAR_HIGHLIGHTING_WEEKENDS','');
if(!defined('CFG_PUBLIC_CALENDAR_DEFAULT_VIEW')) define('CFG_PUBLIC_CALENDAR_DEFAULT_VIEW','month');
if(!defined('CFG_PUBLIC_CALENDAR_HIGHLIGHTING_WEEKENDS')) define('CFG_PUBLIC_CALENDAR_HIGHLIGHTING_WEEKENDS','');
if(!defined('CFG_MAIL_INTEGRATION')) define('CFG_MAIL_INTEGRATION',0);
if(!defined('CFG_MAIL_INTEGRATION_USERS')) define('CFG_MAIL_INTEGRATION_USERS','');
if(!defined('CFG_MAIL_DATETIME_FORMAT')) define('CFG_MAIL_DATETIME_FORMAT',CFG_APP_DATETIME_FORMAT);
if(!defined('CFG_MAIL_ROWS_PER_PAGE')) define('CFG_MAIL_ROWS_PER_PAGE',CFG_APP_ROWS_PER_PAGE);
if(!defined('CFG_MAIL_DISPLAY_IN_MENU')) define('CFG_MAIL_DISPLAY_IN_MENU',0);
if(!defined('CFG_MAIL_DISPLAY_IN_HEADER')) define('CFG_MAIL_DISPLAY_IN_HEADER',1);
if(!defined('CFG_IPAGES_ACCESS_TO_USERS')) define('CFG_IPAGES_ACCESS_TO_USERS','');
if(!defined('CFG_IPAGES_ACCESS_TO_USERS_GROUP')) define('CFG_IPAGES_ACCESS_TO_USERS_GROUP','');
if(!defined('CFG_PUBLIC_CALENDAR_MIN_TIME')) define('CFG_PUBLIC_CALENDAR_MIN_TIME','');
if(!defined('CFG_PUBLIC_CALENDAR_MAX_TIME')) define('CFG_PUBLIC_CALENDAR_MAX_TIME','');
if(!defined('CFG_PUBLIC_CALENDAR_TIME_SLOT_DURATION')) define('CFG_PUBLIC_CALENDAR_TIME_SLOT_DURATION','00:30:00');
if(!defined('CFG_PERSONAL_CALENDAR_MIN_TIME')) define('CFG_PERSONAL_CALENDAR_MIN_TIME','');
if(!defined('CFG_PERSONAL_CALENDAR_MAX_TIME')) define('CFG_PERSONAL_CALENDAR_MAX_TIME','');
if(!defined('CFG_PERSONAL_CALENDAR_TIME_SLOT_DURATION')) define('CFG_PERSONAL_CALENDAR_TIME_SLOT_DURATION','00:30:00');
if(!defined('CFG_PUBLIC_CALENDAR_VIEW_MODES')) define('CFG_PUBLIC_CALENDAR_VIEW_MODES','');
if(!defined('CFG_PERSONAL_CALENDAR_VIEW_MODES')) define('CFG_PERSONAL_CALENDAR_VIEW_MODES','');
if(!defined('CFG_CHAT_SOUND_NOTIFICATION')) define('CFG_CHAT_SOUND_NOTIFICATION','');
if(!defined('CFG_CHAT_INSTANT_NOTIFICATION')) define('CFG_CHAT_INSTANT_NOTIFICATION',0);
