...
<div class="tab-content">
  <div class="tab-pane fade active in" id="general_info">
	  ...
	  <div class="form-group">
	    ...
	    <div class="col-md-9">	
	  	  <p class="form-control-static">
		  	  <?php 
			  	  echo input_file_tag('APP_LOGO',array('accept'=>fieldtype_attachments::get_accept_types_by_extensions('gif,jpg,png'))) . input_hidden_tag('CFG[APP_LOGO]',CFG_APP_LOGO);
	  ...
	  <div class="form-group">
	  	<label class="col-md-3 control-label" for="APP_LOGO"><?php echo TEXT_FAVICON  ?> (32x32)</label>
	    <div class="col-md-9">	
	  	  <p class="form-control-static">
		  	  <?php 
		  	  echo input_file_tag('APP_FAVICON',array('accept'=>fieldtype_attachments::get_accept_types_by_extensions('gif,jpg,png,ico'))) . input_hidden_tag('CFG[APP_FAVICON]',CFG_APP_FAVICON);
			  	  
		  	  if(is_file(DIR_FS_UPLOADS  . '/' . CFG_APP_FAVICON))
			      {
			          echo  '<span class="help-block">' . CFG_APP_FAVICON . '<label class="checkbox">' . input_checkbox_tag('delete_favicon') . ' ' . TEXT_DELETE . '</label></span>';
			      }                                                                                                 	      
	    		?>
	    	</p>
	    </div>			
	...
	?>  
	  ...
	  <div class="form-group">
	  	<label class="col-md-3 control-label" for="CFG_HIDE_POWERED_BY_TEXT"><?php echo TEXT_HIDE .' "' . TEXT_POWERED_BY . ' Rukovoditel"' ?></label>
	    <div class="col-md-9">	
	  	  <?php echo (is_ext_installed() ? select_tag('CFG[HIDE_POWERED_BY_TEXT]',$default_selector,CFG_HIDE_POWERED_BY_TEXT ,array('class'=>'form-control input-small')) : '<p class="form-control-static">' . TEXT_EXTENSION_REQUIRED_URL . '</p>'); ?>
	    </div>			
	  </div> 
