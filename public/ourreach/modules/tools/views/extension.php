						...
						<div class="portlet-body" style="display: block; min-height: 440px;">
							...
							<ul style="list-style:none; padding-left: 0;">
								...
								foreach(explode(',',TEXT_EXT_FEATURES_LIST) as $k=>$v)
								{
									...
									$url = 'https://docs.rukovoditel.net/' . ($app_user['language']=='russian.php' ? 'ru/':''). 'index.php?p=' . (isset($p[$k]) ? $p[$k]:4);
							...
							<center><a href="http://rukovoditel.net/<?php echo ($app_user['language']=='russian.php' ? 'ru/':'')?>extension.html" target="_blank" class="btn btn-primary"><?php echo TEXT_FULL_LIST_OF_FEATURES ?></a></center>
						</div>
					</div>
...
<?php	
	if($app_user['language']=='russian.php')
	{
		echo '
				<li style="padding: 10px;">
						<a href="https://docs.rukovoditel.net/ru/index.php?p=41" target="_blank"><img style="border: 1px solid #adadad" src="images/sliders/ru/ext-home-1.jpg" alt="" /></a>
				</li>
				<li style="padding:10px;">
						<a href="https://docs.rukovoditel.net/ru/index.php?p=36" target="_blank"><img style="border: 1px solid #adadad" src="images/sliders/ru/ext-home-2.jpg" alt="" /></a>
				</li>
	      <li style="padding:10px;">
						<a href="https://docs.rukovoditel.net/ru/index.php?p=44" target="_blank"><img style="border: 1px solid #adadad" src="images/sliders/ru/ext-home-3.jpg" alt="" /></a>
				</li>
			';
	}
	else
	{
		echo '
				<li style="padding: 10px;">
						<a href="https://docs.rukovoditel.net/index.php?p=36" target="_blank"><img style="border: 1px solid #adadad" src="images/sliders/ext-home-1.jpg" alt="" /></a>
				</li>
				<li style="padding:10px;">
						<a href="https://docs.rukovoditel.net/index.php?p=40" target="_blank"><img style="border: 1px solid #adadad" src="images/sliders/ext-home-2.jpg" alt="" /></a>
				</li>												
	      <li style="padding:10px;">
						<a href="https://docs.rukovoditel.net/index.php?p=37" target="_blank"><img style="border: 1px solid #adadad" src="images/sliders/ext-home-3.jpg" alt="" /></a>
				</li>
			';
	}
?>
