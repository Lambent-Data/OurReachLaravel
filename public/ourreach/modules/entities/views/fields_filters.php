...
<h3 class="page-title"><?php echo  $fields_info['name'] . ' <i class="fa fa-angle-right"></i> ' . TEXT_FILTERS ?></h3>
...
<?php echo button_tag(TEXT_BUTTON_ADD_NEW_REPORT_FILTER,url_for('entities/fields_filters_form','reports_id=' . $reports_info['id'] . '&entities_id=' . $_GET['entities_id'] . '&fields_id=' . $_GET['fields_id'])) ?>
...
?>
  <tr>
    <td style="white-space: nowrap;"><?php echo button_icon_delete(url_for('entities/fields_filters_delete','id=' . $v['id'] . '&reports_id=' . $reports_info['id']. '&entities_id=' . $_GET['entities_id']. '&fields_id=' . $_GET['fields_id'])) . ' ' . button_icon_edit(url_for('entities/fields_filters_form','id=' . $v['id'] . '&reports_id=' . $reports_info['id']. '&entities_id=' . $_GET['entities_id']. '&fields_id=' . $_GET['fields_id']))  ?></td>    
