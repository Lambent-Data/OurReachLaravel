...
$reports_type = 'hide_subentity_' . $entities_id; 
$reports_info_query = db_query("select * from app_reports where entities_id='" . db_input($entities_info['parent_id']). "' and reports_type='{$reports_type}'");
...
switch($app_module_action)
{
  case 'save':
    ...
    redirect_to('entities/hide_subentity_filters','reports_id=' . $_GET['reports_id'] . '&entities_id=' . $_GET['entities_id']);      
  break;
  case 'delete':
      if(isset($_GET['id']))
      {      
