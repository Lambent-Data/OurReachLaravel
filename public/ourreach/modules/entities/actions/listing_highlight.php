...
switch($app_module_action)
{
    case 'save':
        ...
        $sql_data = array(
            ...
            'fields_values' => (is_array($_POST['fields_values']) ? implode(',',$_POST['fields_values']) : $_POST['fields_values']),
    ...
    case 'get_field_value':
        ...
        $obj = (isset($_POST['id']) ? db_find('app_listing_highlight_rules',_POST('id')) : db_show_columns('app_listing_highlight_rules'));
        ...
        {               
            ...
            switch(listing_highlight::get_field_type_key($field_info['type']))
            {
                case 'boolean':
                    ...
                    $values_html = select_tag('fields_values[]',$choices,$obj['fields_values'],['class'=>'form-control chosen-select required']);
                    break;
                case 'choices':                                        
                    ...
                    $values_html = select_tag('fields_values[]',$choices,$obj['fields_values'],['class'=>'form-control chosen-select required','multiple'=>'multiple']);
                    break; 
                case 'entities':
                    $parent_entity_item_is_the_same = false;
                    $choices = fieldtype_entity::get_choices($field_info, ['parent_entity_item_id'=>0],'',$parent_entity_item_is_the_same);
                ...
                case 'dates':
                    ...
                    $values_html = input_tag('fields_values',$obj['fields_values'],['class'=>'form-control required']) . tooltip_text(TEXT_FILTER_BY_DAYS_TOOLTIP);
                    break;
                case 'numeric':
