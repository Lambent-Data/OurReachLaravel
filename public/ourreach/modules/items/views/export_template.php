...
echo form_tag('export-form', url_for('items/export_template','path=' . $_GET['path'] . '&templates_id=' . $_GET['templates_id']),['class'=>'form-horizontal']) . input_hidden_tag('action','export');  
...
if($template_info['type']=='docx')
{
   ...
   $buttons_html = '
		<button type="button" class="btn btn-info btn-template-export-pdf"><i class="fa fa-file-pdf-o" aria-hidden="true"></i></button> 		
                <button type="button" class="btn btn-info btn-template-print"><i class="fa fa-print" aria-hidden="true"></i></button>
                <button type="button" class="btn btn-primary btn-template-export"><i class="fa fa-download" aria-hidden="true"></i> ' . TEXT_DOWNLOAD . '</button>';
