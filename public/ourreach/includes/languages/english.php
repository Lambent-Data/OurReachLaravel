...
define('TEXT_FIELDTYPE_SIGNATURE_TOOLTIP','Field allows add Name and Signature. Not related to app users. <a href="https://docs.rukovoditel.net/index.php?p=80" target="_blank"><u>Read more.</u></a>');
...
define('TEXT_ONE_COLUMN_TABS','One column (Tabs)');
define('TEXT_ONE_COLUMN_ACCORDION','One column (Accordion)');
define('TEXT_WINDOW_WIDTH','Window width');
define('TEXT_WIDE','Wide');
define('TEXT_XWIDE','Extra wide');
define('TEXT_FIELDTYPE_JALALI_CALENDAR_TITLE','Jalali calendar');
define('TEXT_FIELDTYPE_JALALI_CALENDAR_TOOLTIP','Jalali calendar is a solar calendar still in use in Iran as well as Afghanistan. Calendar picker will be automatically added to this field.');
define('TEXT_PLAY_AUDIO_FILE','Play an audio file');
...
define('TEXT_INTO_ROW','Into a row');
define('TEXT_IN_NEW_WINDOW','In a new window');
define('TEXT_FIELDS_IN_FORM','Fields in form');
define('TEXT_FIELS_DISPLAY_IN_FOR_TYPE_ROW','With this display, you can use a limited number of fields. Rules for displaying fields in the form are not supported.');
define('TEXT_FIELS_DISPLAY_IN_FOR_TYPE_NEW_WINDOW','By clicking on button the form will be opened in own window. All fields supported in this case.');
define('TEXT_FIELDS_IN_LISTING_ON_FORM_PAGE','The added records are displayed in the table list on the form page.');
define('TEXT_ENTER_COLUMN_WIDHT_BY_COMMA','Enter the width as a percentage for each column, separated by commas.<br>For example: 50,25,25');
define('TEXT_MAX_COUNT_RECORDS','Maximum number of records');
define('TEXT_MAX_COUNT_RECORDS_IN_FORM_INFO','Limit the number of records in the form');
...
define('TEXT_FIELDTYPE_INPUT_IP_TITLE','IPv4 address');
define('TEXT_FIELDTYPE_INPUT_IP_TOOLTIP','A field for entering an IPv4 address. In the database, the value is stored as a number.');
define('TEXT_FIELDTYPE_INPUT_DYNAMIC_MASK_TITLE','Field with dynamic input mask');
define('TEXT_FIELDTYPE_INPUT_DYNAMIC_MASK_TOOLTIP','Allows you to create an input mask for data that does not have a fixed length. You can also add your own JavaScript code to define the mask. The following library is used: <a href="https://github.com/RobinHerbots/Inputmask" target="_blank">github.com/RobinHerbots/Inputmask</a>');
define('TEXT_FIELDTYPE_INPUT_DYNAMIC_MASK_INFO','To define the dynamic part, use the construction {n, m} - this means that the symbol can be repeated from n to m times.');
define('TEXT_FIELDTYPE_INPUT_DYNAMIC_MASK_OPTIONAL_INFO','To define an optional part, use the [a] construction - this means that the character can be omitted.');
