...
class fieldtype_input_date
{
  ...
  function get_configuration()
  {
    ...
    $cfg[TEXT_EXTRA][] = array('title'=>TEXT_IS_UNIQUE_FIELD_VALUE, 'name'=>'is_unique','type'=>'checkbox','tooltip_icon'=>TEXT_IS_UNIQUE_FIELD_VALUE_TIP);
  ...
  function render($field,$obj,$params = array())
  {
    ...
    return '<div class="input-group input-medium date datepicker" ' . implode(' ',$exra_attributes). '>' . input_tag('fields[' . $field['id'] . ']',$value,  $attributes ) . '<span class="input-group-btn"><button class="btn btn-default date-set" type="button"><i class="fa fa-calendar"></i></button></span></div>';
  }
